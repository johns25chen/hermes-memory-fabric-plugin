...
def test_public_constants():
    assert GOVERNANCE_EXECUTION_ADAPTER_HANDOFF_AUDIT_VERSION == "6.4.0"
    assert GOVERNANCE_EXECUTION_ADAPTER_HANDOFF_AUDIT_SCHEMA_VERSION == "6.4.0"
    assert (
        GOVERNANCE_EXECUTION_ADAPTER_HANDOFF_AUDIT_TYPE
...
def test_adapter_handoff_audit_shape_is_deterministic():
    ...
    assert first["manifest_authorization_gate_version"] == "6.4.0"
