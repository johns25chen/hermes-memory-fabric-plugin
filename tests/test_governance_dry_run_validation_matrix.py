...
def test_public_constants():
    assert GOVERNANCE_DRY_RUN_VALIDATION_MATRIX_VERSION == "5.7.0"
    assert GOVERNANCE_DRY_RUN_VALIDATION_MATRIX_SCHEMA_VERSION == "5.7.0"
    assert (
        GOVERNANCE_DRY_RUN_VALIDATION_MATRIX_TYPE
...
def test_validation_matrix_shape_is_deterministic():
    ...
    assert first["fixture_pack_version"] == "5.7.0"
