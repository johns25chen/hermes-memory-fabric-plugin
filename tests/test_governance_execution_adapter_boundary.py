...
def test_public_constants():
    assert GOVERNANCE_EXECUTION_ADAPTER_BOUNDARY_VERSION == "6.4.0"
    assert GOVERNANCE_EXECUTION_ADAPTER_BOUNDARY_SCHEMA_VERSION == "6.4.0"
    assert (
        GOVERNANCE_EXECUTION_ADAPTER_BOUNDARY_TYPE
...
def test_execution_adapter_boundary_shape_is_deterministic():
    ...
    assert first["readiness_audit_version"] == "6.4.0"
