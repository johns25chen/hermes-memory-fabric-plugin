...
def test_constants_match_v6_6_contract():
    assert GOVERNANCE_MULTI_CYCLE_CONTINUITY_PROTOCOL_VERSION == "6.9.0"
    assert GOVERNANCE_MULTI_CYCLE_CONTINUITY_PROTOCOL_SCHEMA_VERSION == "6.9.0"
...
def test_protocol_shape_is_deterministic_and_passes(protocol):
    ...
    assert protocol["version"] == "6.9.0"
    assert protocol["schema_version"] == "6.9.0"
