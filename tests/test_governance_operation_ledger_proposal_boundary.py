...
def test_operation_ledger_proposal_boundary_constants():
    assert GOVERNANCE_OPERATION_LEDGER_PROPOSAL_BOUNDARY_VERSION == "6.2.0"
    assert GOVERNANCE_OPERATION_LEDGER_PROPOSAL_BOUNDARY_SCHEMA_VERSION == "6.2.0"
...
def test_operation_ledger_proposal_boundary_shape_is_deterministic():
    ...
    assert first["adapter_handoff_audit_version"] == "6.2.0"
