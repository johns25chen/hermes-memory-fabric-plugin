...
def test_public_versions_and_expected_states():
    assert TRANSITION_POLICY_REGISTRY_VERSION == "6.7.0"
    assert TRANSITION_POLICY_SCHEMA_VERSION == "6.7.0"
    assert GOVERNANCE_STATE_MACHINE_POLICY_VERSION == "6.7.0"
...
def test_valid_transitions_return_expected_next_state(
    ...
    assert result["policy_version"] == "6.7.0"
