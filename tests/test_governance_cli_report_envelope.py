...
def test_public_constants():
    assert GOVERNANCE_CLI_REPORT_ENVELOPE_VERSION == "5.4.0"
    assert GOVERNANCE_CLI_REPORT_ENVELOPE_SCHEMA_VERSION == "5.4.0"
...
def test_valid_cli_result_wraps_successfully():
    ...
    assert envelope["version"] == "5.4.0"
    assert envelope["schema_version"] == "5.4.0"
    ...
    assert envelope["source_report_version"] == "5.4.0"
