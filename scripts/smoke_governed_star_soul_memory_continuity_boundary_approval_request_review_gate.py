...
from hermes_memory_fabric.governed_star_soul_memory_continuity_boundary_approval_request_proposal import (  # noqa: E402
...
from smoke_governed_star_soul_memory_continuity_boundary_approval_request_proposal import (  # noqa: E402
    _valid_v3_3_star_soul_approval_review_gate_report,
)


LABEL = (
    "governed_star_soul_memory_continuity_boundary_approval_request_review_gate"
)


def _valid_v3_4_star_soul_approval_request_proposal_report() -> (
    dict[str, object]
):
...
def main() -> int:
    try:
        result = build_governed_star_soul_memory_continuity_boundary_approval_request_review_gate(
        ...
        for key, expected in APPROVAL_REQUEST_REVIEW_GATE_FALSE_FLAGS.items():
        ...
        for key, expected in APPROVAL_REQUEST_REVIEW_GATE_OBJECT_FALSE_FLAGS.items():
        ...
        if (
            REVIEWED_CHAIN_VERSIONS != expected_chain
            or result.get("reviewed_chain_versions") != expected_chain
        ):
