#!/usr/bin/env python3
"""Deterministic local smoke for Approval Intent Dry Run."""
...
def main() -> int:
    ...
    with TemporaryDirectory(prefix="approval-intent-dry-run-") as temp_dir_name:
        ...
        try:
            ...
            result = run_memory_approval_intent_dry_run(preview, repo_root=repo_root)
    ...
    print("approval_intent_dry_run_smoke=passed")
    return 0
