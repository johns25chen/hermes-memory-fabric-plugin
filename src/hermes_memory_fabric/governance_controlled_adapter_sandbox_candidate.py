...
GOVERNANCE_CONTROLLED_ADAPTER_SANDBOX_CANDIDATE_VERSION = "6.7.0"
GOVERNANCE_CONTROLLED_ADAPTER_SANDBOX_CANDIDATE_SCHEMA_VERSION = "6.7.0"
...
def build_governance_controlled_adapter_sandbox_candidate() -> dict[str, Any]:
    ...
    blocking_reasons = _deduplicate(
        [
            *(
                ["cross-system coordination boundary must pass at version 6.7.0"]
