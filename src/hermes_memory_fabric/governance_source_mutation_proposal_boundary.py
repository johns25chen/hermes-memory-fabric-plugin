...
GOVERNANCE_SOURCE_MUTATION_PROPOSAL_BOUNDARY_VERSION = "6.7.0"
GOVERNANCE_SOURCE_MUTATION_PROPOSAL_BOUNDARY_SCHEMA_VERSION = "6.7.0"
    ...
    blocking_reasons = _deduplicate(
        [
            ...
            for condition, message in (
                (upstream_version_ready, "Multi-Cycle Continuity Protocol version must be 6.7.0"),
