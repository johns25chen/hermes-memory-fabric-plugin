...
GOVERNANCE_MULTI_CYCLE_CONTINUITY_PROTOCOL_VERSION = "6.6.0"
GOVERNANCE_MULTI_CYCLE_CONTINUITY_PROTOCOL_SCHEMA_VERSION = "6.6.0"
    ...
    blocking_reasons = _deduplicate(
        [
            ...
            for condition, message in (
                (upstream_version_ready, "Root Governance Conflict Resolver version must be 6.6.0"),
