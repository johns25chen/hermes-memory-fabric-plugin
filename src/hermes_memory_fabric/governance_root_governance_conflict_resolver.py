...
GOVERNANCE_ROOT_GOVERNANCE_CONFLICT_RESOLVER_VERSION = "6.9.0"
GOVERNANCE_ROOT_GOVERNANCE_CONFLICT_RESOLVER_SCHEMA_VERSION = "6.9.0"
...
def build_governance_root_governance_conflict_resolver() -> dict[str, Any]:
    ...
    blocking_reasons = _deduplicate(
        [
            *(
                ["Source Memory Invariant Matrix version must be 6.9.0"]
