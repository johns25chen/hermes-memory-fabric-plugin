...
P4_M3_5_PACKAGE_VERSION = "6.16.0"


@dataclass(frozen=True)
class GovernedTransitionIntakeDeclaredTransitionReasonEnvelopeContractField:
    field_order: int
    field_id: str
    field_name: str
    field_purpose: str
    p4_m3_declared_transition_reason_envelope_contract_category: str
    p4_m3_declared_transition_reason_envelope_semantics_disabled: str
...
definition-only
inspection-only
P4-M3.5 declared transition reason envelope definition only
...
P4-M3.5 is not transition reason validation
P4-M3.5 is not reason correctness validation
P4-M3.5 is not justification validation
P4-M3.5 is not rationale validation
P4-M3.5 is not target phase validation
P4-M3.5 is not target phase selection
P4-M3.5 is not phase eligibility validation
P4-M3.5 is not phase compatibility validation
P4-M3.5 is not transition readiness validation
P4-M3.5 is not readiness verdict
P4-M3.5 is not validation verdict
P4-M3.5 is not approval
P4-M3.5 is not authorization
P4-M3.5 is not confirmation
P4-M3.5 is not recommendation
P4-M3.5 is not ranking
P4-M3.5 is not next action generation
P4-M3.5 is not transition execution
P4-M3.5 is not request validation
P4-M3.5 is not evidence validation
P4-M3.5 is not human context validation
P4-M3.5 is not source validation
P4-M3.5 is not citation validation
P4-M3.5 is not transition record creation
P4-M3.5 is not request record creation
P4-M3.5 is not target-phase record creation
P4-M3.5 is not transition-reason record creation
P4-M3.5 is not memory mutation
P4-M3.5 is not roadmap mutation
P4-M3.5 is not lifecycle mutation
P4-M3.5 is not proposal mutation
P4-M3.5 is not evidence mutation
P4-M3.5 is not human context mutation
P4-M3.5 is not target phase mutation
P4-M3.5 is not transition reason mutation
P4-M3.5 is not source fetching
P4-M3.5 is not provenance writing
P4-M3.5 is not citation mutation
...
no reason scoring
no reason ranking
no reason precedence
no reason arbitration
no reason winner selection
no declared reason acceptance
no declared reason rejection
no transition reason persistence
no transition reason storage
no transition reason mutation
no transition-reason record creation
no transition-reason record update
no transition-reason record deletion
...
no P4-M3.6
no P4-M3.6 command
no P4-M3.6 activation
no P4-M3.6 implementation
no P4-M4
no P4-M5
no v7
no productization
...
definition_only
inspection_only
p4_m3_declared_transition_reason_envelope_definition_started
p4_m3_5_governed_transition_intake_declared_transition_reason_envelope_contract_started
p4_m3_5_definition_only
...
p4_m3_declared_transition_reason_envelope_contract_defined
p4_m3_declared_transition_reason_envelope_scope_defined
p4_m3_declared_transition_reason_envelope_field_shape_defined
...
p4_m3_transition_reason_scoring_semantics_prohibited
p4_m3_transition_reason_ranking_semantics_prohibited
p4_m3_transition_reason_record_semantics_prohibited
p4_m3_transition_reason_mutation_semantics_prohibited
...
p4_m3_6_started
p4_m3_6_command_enabled
p4_m3_6_activation_enabled
p4_m3_6_implementation_enabled
p4_m4_started
p4_m5_started
v7_started
...
GOVERNED_TRANSITION_INTAKE_DECLARED_TRANSITION_REASON_ENVELOPE_CONTRACT_BOUNDARY = (
    "P4-M3.5 Governed Transition Intake Declared Transition Reason Envelope "
    "Contract read-only definition-only inspection-only. P4-M3.5 declared "
    "transition reason envelope definition only. P4-M3.4 Governed Transition "
    "Intake Target Phase Envelope Contract remains the source target phase "
    "envelope boundary. P4-M3.3 Governed Transition Intake Declared Human "
    "Context Envelope Contract remains the source declared human context "
    "envelope boundary. P4-M3.2 Governed Transition Intake Evidence Reference "
    "Envelope Contract remains the source evidence reference envelope boundary. "
    "P4-M3.1 Governed Transition Intake Request Envelope Contract remains the "
    "source request envelope boundary. P4-M3.0 Governed Transition Intake "
    "Boundary Contract remains the source intake boundary. P4-M3.5 defines only "
    "the static declared transition reason envelope shape for future governed "
    "transition intake request work; it does not validate transition reason, "
    ...
    "evidence, human context, target phase, transition reason, source, "
    "provenance, or citations; it does not call APIs, MCP, connectors, agents, "
    "or product code; it does not start P4-M3.6, P4-M4, P4-M5, v7, "
    "productization, UI, Operator Console, MVP, deploy, or full Memory Graph "
    "behavior. "
...
_FIELD_NAMES = (
    "P4-M3 Governed Transition Intake Declared Transition Reason Envelope Contract Identifier",
    "P4-M3 Governed Transition Intake Target Phase Envelope Contract Reference",
    "P4-M3 Governed Transition Intake Declared Human Context Envelope Contract Reference",
    "P4-M3 Governed Transition Intake Evidence Reference Envelope Contract Reference",
    "P4-M3 Governed Transition Intake Request Envelope Contract Reference",
...
def _field_purpose(field_id: str) -> str:
    return (
        ...
        "P4-M3.5 declared transition reason envelope definition only context; "
        "P4-M3.4 Governed Transition Intake Target Phase Envelope Contract "
        "remains the source target phase envelope boundary, P4-M3.3 Governed "
        "Transition Intake Declared Human Context Envelope Contract remains the "
        "source declared human context envelope boundary, P4-M3.2 Governed "
        "Transition Intake Evidence Reference Envelope Contract remains the "
        "source evidence reference envelope boundary, P4-M3.1 Governed "
        "Transition Intake Request Envelope Contract remains the source request "
        "envelope boundary, P4-M3.0 Governed Transition Intake Boundary "
        "Contract remains the source intake boundary, P4-M3.5 is not transition "
        "reason validation, not reason correctness validation, not justification "
        "validation, not rationale validation, not target phase validation, not "
        "target phase selection, not transition readiness validation, no "
        "readiness verdict, no validation verdict, no approval, no "
        "authorization, no confirmation, no recommendation, no ranking, no next "
        "action generation, no transition execution, no transition-reason record "
        "creation, no transition reason mutation, no memory mutation, no P4-M3.6, "
        "no P4-M4, no P4-M5, no v7, no productization, no UI, no Operator "
        "Console, no version bump, and no tag."
    )


_GOVERNED_TRANSITION_INTAKE_DECLARED_TRANSITION_REASON_ENVELOPE_CONTRACT_FIELDS = (
    tuple(
        GovernedTransitionIntakeDeclaredTransitionReasonEnvelopeContractField(
            ...
            "p4-m3-declared-transition-reason-envelope-contract-category",
            (
                "no transition reason semantics; no reason correctness semantics; "
                "no validation semantics; no mutation semantics"
            ),
        )
...
def list_governed_transition_intake_declared_transition_reason_envelope_contract_fields() -> (
    tuple[GovernedTransitionIntakeDeclaredTransitionReasonEnvelopeContractField, ...]
):
    return _GOVERNED_TRANSITION_INTAKE_DECLARED_TRANSITION_REASON_ENVELOPE_CONTRACT_FIELDS


def governed_transition_intake_declared_transition_reason_envelope_contract_field_ids() -> (
    tuple[str, ...]
):
    return tuple(
        field.field_id
...
def render_governed_transition_intake_declared_transition_reason_envelope_contract_markdown(
    fields: Sequence[
        GovernedTransitionIntakeDeclaredTransitionReasonEnvelopeContractField
    ]
    | None = None,
    ...
    lines.extend(
        [
            "",
            "## Governed Transition Intake Declared Transition Reason Envelope Contract Fields",
            "",
        ]
    )
    for field in field_values:
        lines.extend(
            [
                ...
                (
                    "- P4-M3 declared transition reason envelope contract category: "
                    f"{field.p4_m3_declared_transition_reason_envelope_contract_category}"
                ),
                (
                    "- P4-M3 declared transition reason envelope semantics disabled: "
                    f"{field.p4_m3_declared_transition_reason_envelope_semantics_disabled}"
                ),
                "",
            ]
        )
...
def governed_transition_intake_declared_transition_reason_envelope_contract_as_dicts() -> (
...
def governed_transition_intake_declared_transition_reason_envelope_contract_report() -> (
    dict[str, object]
):
    status: dict[str, object] = {
        "phase": "P4-M3.5",
        "feature": "Governed Transition Intake Declared Transition Reason Envelope Contract",
        "mode": "read-only",
        "package_version": P4_M3_5_PACKAGE_VERSION,
        (
            "governed_transition_intake_declared_transition_reason_envelope_"
