...
GOVERNANCE_ORIGIN_PROVENANCE_LEDGER_VERSION = "6.7.0"
GOVERNANCE_ORIGIN_PROVENANCE_LEDGER_SCHEMA_VERSION = "6.7.0"
...
def build_governance_origin_provenance_ledger() -> dict[str, Any]:
    ...
    blocking_reasons = _deduplicate(
        [
            *(
                ["Source Constitution Registry version must be 6.7.0"]
