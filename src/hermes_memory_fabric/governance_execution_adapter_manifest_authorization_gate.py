...
GOVERNANCE_EXECUTION_ADAPTER_MANIFEST_AUTHORIZATION_GATE_VERSION = "5.9.0"
GOVERNANCE_EXECUTION_ADAPTER_MANIFEST_AUTHORIZATION_GATE_SCHEMA_VERSION = "5.9.0"
...
def build_governance_execution_adapter_manifest_authorization_gate() -> dict[str, Any]:
    ...
    blocking_reasons = _deduplicate(
        [
            *(
                ["manifest approval gate must pass at version 5.9.0"]
...
def _manifest_approval_gate_blocking_reasons(
    ...
    return _deduplicate(
        [
            ...
            *(
                ["manifest approval gate version must equal 5.9.0"]
