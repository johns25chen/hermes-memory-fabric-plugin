...
GOVERNANCE_DRY_RUN_FIXTURE_PACK_VERSION = "4.8.0"
GOVERNANCE_DRY_RUN_FIXTURE_SCHEMA_VERSION = "4.8.0"
...
_SENSITIVE_VALUES = {
    "approval_phrase": "fixture-approval-phrase-4-8",
    "stdout_tail": "fixture-stdout-tail-4-8",
    "stdout": "fixture-stdout-4-8",
    "raw_logs": "fixture-raw-logs-4-8",
    "token": "fixture-token-4-8",
    "api_key": "fixture-api-key-4-8",
    "secret": "fixture-secret-4-8",
    "password": "fixture-password-4-8",
    "credential": "fixture-credential-4-8",
}


def build_governance_dry_run_fixture_pack() -> dict[str, Any]:
    """Build the v4.8 governance fixture pack."""
