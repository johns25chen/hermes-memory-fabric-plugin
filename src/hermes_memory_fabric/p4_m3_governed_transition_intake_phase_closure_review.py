...
from .p4_m3_governed_transition_intake_closure_handoff_contract import governed_transition_intake_closure_handoff_contract_field_ids
...
P4_M3_15_PACKAGE_VERSION = "6.16.0"


@dataclass(frozen=True)
class GovernedTransitionIntakePhaseClosureReviewField:
    field_order: int
    field_id: str
    field_name: str
    field_purpose: str
    p4_m3_phase_closure_review_category: str
    p4_m3_phase_closure_review_semantics_disabled: str
...
BOUNDARY_PHRASE_LINES = (
    ...
    "definition-only",
    "inspection-only",
    "P4-M3.15 phase closure review definition only",
    ...
    "P4-M2.17 P4-M2 Closure Handoff Contract remains the prior phase closure reference",
    "P4-M4 remains deferred",
    "P4-M4 entry gate remains not implemented",
    "P4-M3.15 is not live validation",
    "P4-M3.15 is not phase validation",
    "P4-M3.15 is not transition intake validation",
    "P4-M3.15 is not package validation",
    "P4-M3.15 is not final audit validation",
    "P4-M3.15 is not closure validation",
    "P4-M3.15 is not handoff validation",
    "P4-M3.15 is not entry gate validation",
    "P4-M3.15 is not P4-M4 entry gate implementation",
    "P4-M3.15 is not P4-M4 activation",
    "P4-M3.15 is not P4-M4 readiness validation",
    "P4-M3.15 is not P4-M4 execution",
    "P4-M3.15 is not closure execution",
    "P4-M3.15 is not handoff execution",
    "P4-M3.15 is not phase closure execution",
    "P4-M3.15 is not package correctness validation",
    "P4-M3.15 is not package completeness validation",
    "P4-M3.15 is not package consistency validation",
    "P4-M3.15 is not package integrity validation",
    "P4-M3.15 is not package readiness validation",
    "P4-M3.15 is not package readiness verdict",
    "P4-M3.15 is not package validation verdict",
    "P4-M3.15 is not reference resolution",
    "P4-M3.15 is not reference integrity validation",
    "P4-M3.15 is not reference completeness validation",
    "P4-M3.15 is not transition safeguard validation",
    "P4-M3.15 is not transition assumption validation",
    "P4-M3.15 is not transition risk validation",
    "P4-M3.15 is not transition impact validation",
    "P4-M3.15 is not transition dependency validation",
    "P4-M3.15 is not transition constraint validation",
    "P4-M3.15 is not transition reason validation",
    "P4-M3.15 is not target phase validation",
    "P4-M3.15 is not target phase selection",
    "P4-M3.15 is not transition readiness validation",
    "P4-M3.15 is not readiness verdict",
    "P4-M3.15 is not validation verdict",
    "P4-M3.15 is not closure verdict",
    "P4-M3.15 is not handoff verdict",
    "P4-M3.15 is not phase closure verdict",
    "P4-M3.15 is not P4-M4 entry verdict",
    "P4-M3.15 is not boundary certification",
    "P4-M3.15 is not approval",
    "P4-M3.15 is not authorization",
    "P4-M3.15 is not confirmation",
    "P4-M3.15 is not recommendation",
    "P4-M3.15 is not ranking",
    "P4-M3.15 is not next action generation",
    "P4-M3.15 is not transition execution",
    "P4-M3.15 is not request validation",
    "P4-M3.15 is not evidence validation",
    "P4-M3.15 is not human context validation",
    "P4-M3.15 is not source validation",
    "P4-M3.15 is not citation validation",
    "P4-M3.15 is not transition record creation",
    "P4-M3.15 is not request record creation",
    "P4-M3.15 is not package record creation",
    "P4-M3.15 is not closure record creation",
    "P4-M3.15 is not handoff record creation",
    "P4-M3.15 is not phase closure record creation",
    "P4-M3.15 is not P4-M4 entry record creation",
    "P4-M3.15 is not memory mutation",
    "P4-M3.15 is not roadmap mutation",
    "P4-M3.15 is not lifecycle mutation",
    "P4-M3.15 is not proposal mutation",
    "P4-M3.15 is not evidence mutation",
    "P4-M3.15 is not human context mutation",
    "P4-M3.15 is not target phase mutation",
    "P4-M3.15 is not transition reason mutation",
    "P4-M3.15 is not transition constraint mutation",
    "P4-M3.15 is not transition dependency mutation",
    "P4-M3.15 is not transition impact mutation",
    "P4-M3.15 is not transition risk mutation",
    "P4-M3.15 is not transition assumption mutation",
    "P4-M3.15 is not transition safeguard mutation",
    "P4-M3.15 is not package mutation",
    "P4-M3.15 is not closure mutation",
    "P4-M3.15 is not handoff mutation",
    "P4-M3.15 is not phase closure mutation",
    "P4-M3.15 is not source fetching",
    "P4-M3.15 is not provenance writing",
    "P4-M3.15 is not citation mutation",
...
TRUE_STATUS_FLAGS = (
    "definition_only",
    "inspection_only",
    "p4_m3_phase_closure_review_definition_started",
    "p4_m3_15_governed_transition_intake_phase_closure_review_started",
    "p4_m3_15_definition_only",
    ...
    "p4_m3_phase_closure_review_defined",
    "p4_m3_phase_closure_review_scope_defined",
    "p4_m3_phase_closure_review_field_shape_defined",
    "p4_m3_governed_transition_intake_static_definition_chain_reviewed_for_closure",
    "p4_m3_static_definition_chain_closed_before_p4_m4_entry_gate",
...
GOVERNED_TRANSITION_INTAKE_PHASE_CLOSURE_REVIEW_BOUNDARY = (
    "P4-M3.15 Governed Transition Intake Phase Closure Review read-only "
    "definition-only inspection-only. P4-M3.15 phase closure review "
    "definition only. "
    + " ".join(f"{phrase}." for phrase in BOUNDARY_PHRASE_LINES)
)

_FIELD_IDS = (
    "p4-m3-governed-transition-intake-phase-closure-review-id",
    ...
    "p4-m3-governed-transition-intake-phase-closure-review-scope",
    "p4-m3-governed-transition-intake-phase-closure-review-semantics-disabled",
)
...
def _field_purpose(field_id: str) -> str:
    return (
        ...
        "P4-M3.15 phase closure review definition only context; "
        "P4-M3.14 Governed Transition Intake Closure Handoff Contract remains "
        "the source closure handoff contract; P4-M3.13 Governed Transition "
        "Intake Final Non-Validation Boundary Audit remains the source final "
        "non-validation boundary audit; P4-M4 remains deferred; P4-M4 entry "
        "gate remains not implemented; no live validation; no phase "
        "validation; no transition intake validation; no package validation; "
        "no final audit validation; no closure validation; no handoff "
        "validation; no entry gate validation; no P4-M4 entry gate "
        "implementation; no P4-M4 activation; no P4-M4 execution; no closure "
        "execution; no handoff execution; no phase closure execution; no "
        "readiness verdict; no validation verdict; no closure verdict; no "
        "handoff verdict; no phase closure verdict; no P4-M4 entry verdict; "
        "no boundary certification; no approval; no authorization; no "
        "confirmation; no recommendation; no ranking; no next action "
        "generation; no transition execution; no request validation; no "
        "evidence validation; no memory mutation; no roadmap mutation; no "
        "closure record creation; no handoff record creation; no phase closure "
        "record creation; no P4-M4 entry record creation; no closure mutation; "
        "no handoff mutation; no phase closure mutation; no P4-M4; no P4-M5; "
        "no v7; no productization; no UI; no Operator Console; no version "
        "bump; no tag."
    )


_GOVERNED_TRANSITION_INTAKE_PHASE_CLOSURE_REVIEW_FIELDS = tuple(
    GovernedTransitionIntakePhaseClosureReviewField(
        index,
        field_id,
        _FIELD_NAMES[index - 1],
        _field_purpose(field_id),
        "p4-m3-governed-transition-intake-phase-closure-review-category",
        (
            "no live validation semantics; no phase validation semantics; no "
            "transition intake validation semantics; no package validation "
            "semantics; no final audit validation semantics; no closure "
            "validation semantics; no handoff validation semantics; no entry "
            "gate validation semantics; no P4-M4 entry gate implementation "
            "semantics; no P4-M4 activation semantics; no P4-M4 execution "
            "semantics; no closure execution semantics; no handoff execution "
            "semantics; no phase closure execution semantics; no verdict "
...
def list_governed_transition_intake_phase_closure_review_fields() -> tuple[GovernedTransitionIntakePhaseClosureReviewField, ...]:
    return _GOVERNED_TRANSITION_INTAKE_PHASE_CLOSURE_REVIEW_FIELDS


def governed_transition_intake_phase_closure_review_field_ids() -> tuple[str, ...]:
    return tuple(
        field.field_id
        for field in list_governed_transition_intake_phase_closure_review_fields()
    )


def render_governed_transition_intake_phase_closure_review_markdown(
    fields: Sequence[GovernedTransitionIntakePhaseClosureReviewField] | None = None,
) -> str:
    field_values = tuple(fields) if fields is not None else list_governed_transition_intake_phase_closure_review_fields()
    status = governed_transition_intake_phase_closure_review_report()
    lines = [
        "# P4-M3.15 Governed Transition Intake Phase Closure Review",
        "",
        "P4-M3.15 Governed Transition Intake Phase Closure Review.",
        "",
        "read-only.",
    ...
    lines.extend(["", "## Governed Transition Intake Phase Closure Review Fields", ""])
    for field in field_values:
        lines.extend([
            ...
            "- P4-M3 phase closure review category: "
            f"{field.p4_m3_phase_closure_review_category}",
            "- P4-M3 phase closure review semantics disabled: "
            f"{field.p4_m3_phase_closure_review_semantics_disabled}",
            "",
        ])
    return "\n".join(lines).rstrip() + "\n"


def governed_transition_intake_phase_closure_review_as_dicts() -> tuple[dict[str, object], ...]:
    return tuple(
        asdict(field)
        for field in list_governed_transition_intake_phase_closure_review_fields()
    )
...
def governed_transition_intake_phase_closure_review_report() -> dict[str, object]:
    status: dict[str, object] = {
        "phase": "P4-M3.15",
        "feature": "Governed Transition Intake Phase Closure Review",
        "mode": "read-only",
        "boundary": GOVERNED_TRANSITION_INTAKE_PHASE_CLOSURE_REVIEW_BOUNDARY,
        "package_version": P4_M3_15_PACKAGE_VERSION,
        "governed_transition_intake_phase_closure_review_field_count": len(_FIELD_IDS),
        "referenced_p4_m3_14_closure_handoff_contract_field_count": len(
