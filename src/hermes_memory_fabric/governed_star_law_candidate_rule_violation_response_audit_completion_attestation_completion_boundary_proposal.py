"""Governed Star-Law audit completion attestation completion boundary proposal."""
...
from .governed_star_law_candidate_rule_violation_response_audit_completion_attestation_finalization_boundary_review_gate import (
...
GOVERNED_STAR_LAW_CANDIDATE_RULE_VIOLATION_RESPONSE_AUDIT_COMPLETION_ATTESTATION_COMPLETION_BOUNDARY_PROPOSAL_VERSION = (
    "2.55.0"
)
SOURCE_REVIEW_GATE_VERSION = "2.54.0"

PROPOSED_CHAIN_VERSIONS = [*SOURCE_REVIEWED_CHAIN_VERSIONS, "v2.54.0"]
...
LAYER_MAPPING = {
    ...
    "source_layer": "星律记忆",
    "source_layer_status": "Star-Law candidate rule violation response audit completion attestation finalization boundary review gate complete for human review only",
    "supporting_layers": ["星穹记忆", "星域记忆", "星界记忆", "星辰记忆"],
    "direction": "Star-Law candidate rule violation response audit completion attestation finalization boundary review gate -> Star-Law candidate rule violation response audit completion attestation completion boundary proposal",
}
...
ATTESTATION_COMPLETION_FALSE_FLAGS = {
    "candidate_rule_violation_response_audit_completion_attestation_completion_performed": False,
    "candidate_rule_violation_response_audit_completion_attestation_completion_authorized": False,
    "candidate_rule_violation_response_audit_completion_attestation_completion_executed": False,
    "candidate_rule_violation_response_audit_completion_attestation_completion_execution_authorized": False,
    "candidate_rule_violation_response_audit_completion_attestation_completion_record_created": False,
    "candidate_rule_violation_response_audit_completion_attestation_completion_ledger_entry_created": False,
}
...
SOURCE_REQUIRED_FLAGS = {
    ...
    "candidate_rule_violation_response_audit_completion_attestation_finalization_boundary_reviewed_for_human_review_only": True,
    "candidate_rule_violation_response_audit_completion_attestation_completion_boundary_proposal_ready_for_human_review_only": True,
    **SOURCE_REVIEW_GATE_FALSE_FLAGS,
}

SOURCE_REVIEW_GATE_REQUIRED_FLAGS = {
    "candidate_rule_violation_response_audit_completion_attestation_finalization_boundary_reviewed": True,
    "candidate_rule_violation_response_audit_completion_attestation_finalization_boundary_structurally_review_ready": True,
    "candidate_rule_violation_response_audit_completion_attestation_completion_boundary_proposal_ready_for_human_review_only": True,
    "source_star_law_candidate_rule_violation_response_audit_completion_attestation_finalization_boundary_proposal_valid": True,
...
PROPOSED_CANDIDATE_RULE_VIOLATION_RESPONSE_AUDIT_COMPLETION_ATTESTATION_COMPLETION_BOUNDARY_KEYS = {
    "response_audit_completion_attestation_completion_eligibility_boundary",
    "response_audit_completion_attestation_completion_input_boundary",
    "response_audit_completion_attestation_completion_output_boundary",
    "response_audit_completion_attestation_completion_non_execution_boundary",
    "response_audit_completion_attestation_completion_non_recording_boundary",
    "response_audit_completion_attestation_completion_non_ledger_boundary",
    "response_audit_completion_attestation_completion_non_authorization_boundary",
...
PROPOSAL_COMPONENTS = {
    "source_candidate_rule_violation_response_audit_completion_attestation_finalization_boundary_review_gate",
    *PROPOSED_CANDIDATE_RULE_VIOLATION_RESPONSE_AUDIT_COMPLETION_ATTESTATION_COMPLETION_BOUNDARY_KEYS,
}


def build_governed_star_law_candidate_rule_violation_response_audit_completion_attestation_completion_boundary_proposal(
    review_gate_report: Mapping[str, Any],
) -> dict[str, Any]:
    """Return a local-only, non-authorizing attestation completion proposal."""
    ...
    return {
        "version": GOVERNED_STAR_LAW_CANDIDATE_RULE_VIOLATION_RESPONSE_AUDIT_COMPLETION_ATTESTATION_COMPLETION_BOUNDARY_PROPOSAL_VERSION,
        "status": status,
        **PROPOSAL_FLAGS,
        "candidate_rule_violation_response_audit_completion_attestation_completion_boundary_proposed_for_human_review_only": ready,
        "candidate_rule_violation_response_audit_completion_attestation_completion_boundary_review_gate_ready_for_human_review_only": ready,
        ...
        "star_law_candidate_rule_violation_response_audit_completion_attestation_completion_boundary_proposal_summary": _proposal_summary(
            ready
        ),
        "proposal_checks": checks,
        "source_review_gate_summary": _source_review_gate_summary(ready),
        "star_law_candidate_rule_violation_response_audit_completion_attestation_completion_boundary_proposal": _completion_boundary_proposal(
            ready
        ),
        "proposed_candidate_rule_violation_response_audit_completion_attestation_completion_boundaries": _proposed_completion_boundaries(
            ready
        ),
        ...
        "future_candidate_rule_violation_response_audit_completion_attestation_completion_review_gate_constraints": _future_review_gate_constraints(),
...
def governed_star_law_candidate_rule_violation_response_audit_completion_attestation_completion_boundary_proposal_to_json(
    report: Mapping[str, Any],
) -> str:
    """Serialize the attestation completion proposal deterministically."""
...
def _proposal_checks(
    ...
    required_values = {
        "source_review_gate_version": (
            ...
            "source_review_gate_version_must_be_2_54_0",
        ),
        "source_review_gate_status_ready": (
            ...
            "source_review_gate_status_must_be_star_law_candidate_rule_violation_response_audit_completion_attestation_finalization_boundary_review_gate_ready",
        ),
        "source_reviewed_chain_versions": (
            report.get("reviewed_chain_versions")
            == SOURCE_REVIEWED_CHAIN_VERSIONS,
            "source_reviewed_chain_versions_must_exactly_match_v2_9_0_through_v2_53_0",
        ),
        "source_reviewed_star_hub_chain_versions": (
            report.get("reviewed_star_hub_chain_versions")
            == SOURCE_REVIEWED_STAR_HUB_CHAIN_VERSIONS,
            "source_reviewed_star_hub_chain_versions_must_exactly_match_v2_19_0_through_v2_53_0",
        ),
        "source_next_allowed_step": (
            ...
            "source_next_allowed_step_must_be_v2_55_0_attestation_completion_boundary_proposal",
        ),
    ...
    if isinstance(mapping, Mapping):
        ...
        layer_checks = {
            ...
            "source_primary_layer_status": (
                ...
                == "Star-Law candidate rule violation response audit completion attestation finalization boundary review gate only, not finalization execution, not finalization record creation, not finalization-ledger creation, not closure execution, not closure record creation, not closure-ledger creation, not attestation execution, not attestation record creation, not attestation-ledger creation, not completion execution, not audit execution, not audit logging, not audit record creation, not audit-ledger creation, not violation response execution, not automated correction, not violation enforcement, and not autonomous execution",
                "source_primary_layer_status_must_be_attestation_finalization_boundary_review_gate_only",
            ),
            "source_source_layer": (
            ...
            "source_source_layer_status": (
                ...
                == "Star-Law candidate rule violation response audit completion attestation finalization boundary proposal complete for human review only",
                "source_source_layer_status_must_be_attestation_finalization_boundary_proposal_complete_for_human_review_only",
            ),
    ...
    review_gate = report.get(
        "star_law_candidate_rule_violation_response_audit_completion_attestation_finalization_boundary_review_gate"
    )
    _add_check(
        checks,
        blocking_reasons,
        "source_attestation_finalization_boundary_review_gate_shape",
        isinstance(review_gate, Mapping),
        "source_attestation_finalization_boundary_review_gate_must_be_mapping",
    )
    if isinstance(review_gate, Mapping):
        _add_check(
            checks,
            blocking_reasons,
            "source_attestation_finalization_boundary_review_gate_status",
            ...
            "source_attestation_finalization_boundary_review_gate_status_must_be_human_review_only",
        )
        for key, expected in SOURCE_REVIEW_GATE_REQUIRED_FLAGS.items():
            _add_check(
                checks,
                blocking_reasons,
                f"source_attestation_finalization_boundary_review_gate_{key}",
                review_gate.get(key) is expected,
                f"source_attestation_finalization_boundary_review_gate_{key}_must_be_{str(expected).lower()}",
            )

    boundaries = report.get(
        "reviewed_candidate_rule_violation_response_audit_completion_attestation_finalization_boundaries"
    )
    _add_check(
        checks,
        blocking_reasons,
        "source_reviewed_attestation_finalization_boundaries_shape",
        isinstance(boundaries, Mapping),
        "source_reviewed_attestation_finalization_boundaries_must_be_mapping",
    )
    if isinstance(boundaries, Mapping):
        _add_check(
            checks,
            blocking_reasons,
            "source_reviewed_attestation_finalization_boundaries_required_keys",
            set(boundaries)
            == SOURCE_PROPOSED_CANDIDATE_RULE_VIOLATION_RESPONSE_AUDIT_COMPLETION_ATTESTATION_FINALIZATION_BOUNDARY_KEYS,
            "source_reviewed_attestation_finalization_boundaries_must_exactly_match_required_boundaries",
        )
        _add_check(
            checks,
            blocking_reasons,
            "source_reviewed_attestation_finalization_boundaries_review_only",
            _reviewed_boundaries_remain_review_only(boundaries),
            "source_reviewed_attestation_finalization_boundaries_must_remain_review_only_and_non_authorizing",
        )
        _add_check(
            checks,
            blocking_reasons,
            "source_reviewed_attestation_finalization_boundaries_no_unsafe_claims",
            _unsafe_boundary_claims(boundaries, {"review_only"}) == [],
            "source_reviewed_attestation_finalization_boundaries_must_not_claim_execution_authorization_recording_enforcement_or_write_actions",
        )
...
def _proposal_summary(ready: bool) -> dict[str, Any]:
    return {
        ...
        "source_review_gate_version": SOURCE_REVIEW_GATE_VERSION,
        "source_attestation_finalization_boundary_review_gate_valid": ready,
        "candidate_rule_violation_response_audit_completion_attestation_completion_boundary_proposed_for_human_review_only": ready,
        "candidate_rule_violation_response_audit_completion_attestation_completion_boundary_review_gate_ready_for_human_review_only": ready,
        "proposal_only": True,
...
def _completion_boundary_proposal(ready: bool) -> dict[str, Any]:
    return {
        "proposal_status": (
            "star_law_candidate_rule_violation_response_audit_completion_attestation_completion_boundary_proposed_for_human_review_only"
            if ready
            else "blocked_no_attestation_completion_boundary_readiness_claim"
        ),
        "boundary_type": "star_law_candidate_rule_violation_response_audit_completion_attestation_completion_boundary_proposal",
        "source_review_gate_version": SOURCE_REVIEW_GATE_VERSION,
        "candidate_rule_violation_response_audit_completion_attestation_completion_boundary_proposed": ready,
        "candidate_rule_violation_response_audit_completion_attestation_completion_boundary_review_gate_ready_for_human_review_only": ready,
        "source_star_law_candidate_rule_violation_response_audit_completion_attestation_finalization_boundary_review_gate_valid": ready,
        **PROPOSAL_OBJECT_FALSE_FLAGS,
        "proposed_chain_versions": list(PROPOSED_CHAIN_VERSIONS),
        "proposed_star_hub_chain_versions": list(
            PROPOSED_STAR_HUB_CHAIN_VERSIONS
        ),
        "star_law_candidate_rule_violation_response_audit_completion_attestation_completion_boundary_components": _proposal_components(
            ready
        ),
        "next_allowed_step": READY_NEXT_ALLOWED_STEP,
        "non_authorization_notice": (
            "This proposal describes candidate audit completion attestation completion boundaries for Human Operator review only. It performs no completion, finalization, closure, attestation, audit, response, correction, enforcement, record creation, ledger creation, write, approval, handoff, scheduling, dry-run, or autonomous action."
            if ready
            else "The attestation completion boundary proposal is blocked and makes no readiness, execution, authorization, recording, ledger, enforcement, write, approval, handoff, scheduling, next-layer, or Civilization Core completion claim."
        ),
    }
...
def _boundary_summary(key: str) -> str:
    summaries = {
        "response_audit_completion_attestation_completion_eligibility_boundary": "Eligibility is limited to a valid sanitized v2.54 review gate and exact chain traceability.",
        "response_audit_completion_attestation_completion_input_boundary": "Inputs are limited to structural review status, chain metadata, layer mapping, and review-only boundary shape.",
        "response_audit_completion_attestation_completion_output_boundary": "Outputs are limited to sanitized proposal categories for a later governed review gate.",
        "human_operator_completion_review_boundary": "Human Operator review is required before any later governed completion stage.",
        "evidence_lineage_completion_boundary": "Evidence lineage is limited to source version and exact chain metadata.",
        "auditability_completion_design_boundary": "Auditability is limited to deterministic local report structure.",
        "false_positive_completion_prevention_boundary": "False-positive completion prevention remains a required later Human Operator review concern.",
        "rollback_completion_boundary": "Rollback is a proposal category without rollback action.",
        "suspension_completion_boundary": "Suspension is a proposal category without suspension action.",
...
def _non_authorization_boundary(ready: bool) -> dict[str, Any]:
    return {
        ...
        "only_permits_later_attestation_completion_boundary_review_gate": ready,
...
def _future_review_gate_constraints() -> list[str]:
    return [
        "A later v2.56.0 attestation completion boundary review gate may consume this sanitized proposal through a separate governed process.",
...
def _next_stage_constraints() -> list[str]:
    return [
        ...
        "v2.55.0 is an audit completion attestation completion boundary proposal only.",
...
def _scope_boundaries() -> list[str]:
    return [
        ...
        "This v2.55.0 step is limited to 星律记忆 audit completion attestation completion boundary proposal only.",
    ]
...
def _required_human_actions(
    ...
    if ready:
        return [
            "human_operator_must_review_v2_55_0_attestation_completion_boundary_proposal_before_any_v2_56_0_review_gate",
    ...
    actions = [
        "repair_source_v2_54_0_attestation_finalization_boundary_review_gate_before_attestation_completion_boundary_proposal_can_continue",
        ...
        "rerun_local_v2_55_0_attestation_completion_boundary_proposal_after_blockers_are_resolved",
    ]
    if blocking_reasons:
        actions.append(
            "resolve_blocking_reasons_before_attestation_completion_boundary_proposal_can_be_ready"
        )
    return actions
...
__all__ = [
    ...
    "PROPOSAL_COMPONENTS",
    "SENSITIVE_KEYS",
    "build_governed_star_law_candidate_rule_violation_response_audit_completion_attestation_completion_boundary_proposal",
    "governed_star_law_candidate_rule_violation_response_audit_completion_attestation_completion_boundary_proposal_to_json",
]
