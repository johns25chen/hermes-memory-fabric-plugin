...
GOVERNANCE_OPERATION_LEDGER_PROPOSAL_BOUNDARY_VERSION = "5.12.0"
GOVERNANCE_OPERATION_LEDGER_PROPOSAL_BOUNDARY_SCHEMA_VERSION = "5.12.0"
...
def build_governance_operation_ledger_proposal_boundary() -> dict[str, Any]:
    ...
    blocking_reasons = _deduplicate(
        [
            *(
                ["adapter handoff audit must pass at version 5.12.0"]
