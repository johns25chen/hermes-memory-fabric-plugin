...
GOVERNANCE_EXECUTION_ADAPTER_MANIFEST_APPROVAL_GATE_VERSION = "6.9.0"
GOVERNANCE_EXECUTION_ADAPTER_MANIFEST_APPROVAL_GATE_SCHEMA_VERSION = "6.9.0"
...
def build_governance_execution_adapter_manifest_approval_gate() -> dict[str, Any]:
    ...
    blocking_reasons = _deduplicate(
        [
            *(
                ["manifest policy gate must pass at version 6.9.0"]
...
def _manifest_policy_gate_blocking_reasons(
    ...
    return _deduplicate(
        [
            ...
            *(
                ["manifest policy gate version must equal 6.9.0"]
