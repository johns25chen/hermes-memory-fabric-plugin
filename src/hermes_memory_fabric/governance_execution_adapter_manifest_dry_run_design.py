...
GOVERNANCE_EXECUTION_ADAPTER_MANIFEST_DRY_RUN_DESIGN_VERSION = "6.9.0"
GOVERNANCE_EXECUTION_ADAPTER_MANIFEST_DRY_RUN_DESIGN_SCHEMA_VERSION = "6.9.0"
...
def build_governance_execution_adapter_manifest_dry_run_design() -> dict[str, Any]:
    ...
    blocking_reasons = _deduplicate(
        [
            *(
                ["declaration schema registry must pass at version 6.9.0"]
        ...
        _contract(
            ...
            blocking_reasons=_deduplicate(
                [
                    ...
                    *(
                        ["declaration schema registry version must equal 6.9.0"]
