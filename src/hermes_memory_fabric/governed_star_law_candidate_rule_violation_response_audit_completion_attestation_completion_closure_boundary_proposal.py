"""Governed Star-Law audit completion attestation completion closure boundary proposal."""
...
from .governed_star_law_candidate_rule_violation_response_audit_completion_attestation_completion_boundary_review_gate import (
    ...
    SENSITIVE_KEYS,
    SOURCE_PROPOSED_CANDIDATE_RULE_VIOLATION_RESPONSE_AUDIT_COMPLETION_ATTESTATION_COMPLETION_BOUNDARY_KEYS,
)


GOVERNED_STAR_LAW_CANDIDATE_RULE_VIOLATION_RESPONSE_AUDIT_COMPLETION_ATTESTATION_COMPLETION_CLOSURE_BOUNDARY_PROPOSAL_VERSION = (
    "2.57.0"
)
SOURCE_REVIEW_GATE_VERSION = "2.56.0"

PROPOSED_CHAIN_VERSIONS = [*SOURCE_REVIEWED_CHAIN_VERSIONS, "v2.56.0"]
...
LAYER_MAPPING = {
    "primary_layer": "星律记忆",
    "primary_layer_status": "Star-Law candidate rule violation response audit completion attestation completion closure boundary proposal only, not closure execution, not closure record creation, not closure-ledger creation, not completion execution, not completion record creation, not completion-ledger creation, not finalization execution, not finalization record creation, not finalization-ledger creation, not attestation execution, not attestation record creation, not attestation-ledger creation, not audit execution, not audit logging, not audit record creation, not audit-ledger creation, not violation response execution, not automated correction, not violation enforcement, and not autonomous execution",
    "source_layer": "星律记忆",
    "source_layer_status": "Star-Law candidate rule violation response audit completion attestation completion boundary review gate complete for human review only",
    "supporting_layers": ["星穹记忆", "星域记忆", "星界记忆", "星辰记忆"],
    "direction": "Star-Law candidate rule violation response audit completion attestation completion boundary review gate -> Star-Law candidate rule violation response audit completion attestation completion closure boundary proposal",
}

READY_NEXT_ALLOWED_STEP = (
    "v2.58.0 Star-Law candidate rule violation response audit completion attestation completion closure boundary review gate"
)

COMPLETION_CLOSURE_FALSE_FLAGS = {
    "candidate_rule_violation_response_audit_completion_attestation_completion_closure_performed": False,
    "candidate_rule_violation_response_audit_completion_attestation_completion_closure_authorized": False,
    "candidate_rule_violation_response_audit_completion_attestation_completion_closure_executed": False,
    "candidate_rule_violation_response_audit_completion_attestation_completion_closure_execution_authorized": False,
    "candidate_rule_violation_response_audit_completion_attestation_completion_closure_record_created": False,
    "candidate_rule_violation_response_audit_completion_attestation_completion_closure_ledger_entry_created": False,
}
...
PROPOSAL_FLAGS = {
    ...
    "proposal_only": True,
    "candidate_rule_violation_response_audit_completion_attestation_completion_closure_boundary_proposal_only": True,
    "star_law_candidate_rule_violation_response_audit_completion_attestation_completion_closure_boundary_proposal_only": True,
    **PROPOSAL_FALSE_FLAGS,
}
...
SOURCE_REQUIRED_FLAGS = {
    ...
    "candidate_rule_violation_response_audit_completion_attestation_completion_boundary_review_gate_only": True,
    "star_law_candidate_rule_violation_response_audit_completion_attestation_completion_boundary_review_gate_only": True,
    "candidate_rule_violation_response_audit_completion_attestation_completion_boundary_reviewed_for_human_review_only": True,
    "candidate_rule_violation_response_audit_completion_attestation_completion_closure_boundary_proposal_ready_for_human_review_only": True,
    **SOURCE_REVIEW_GATE_FALSE_FLAGS,
}

SOURCE_REVIEW_GATE_REQUIRED_FLAGS = {
    "candidate_rule_violation_response_audit_completion_attestation_completion_boundary_reviewed": True,
    "candidate_rule_violation_response_audit_completion_attestation_completion_boundary_structurally_review_ready": True,
    "candidate_rule_violation_response_audit_completion_attestation_completion_closure_boundary_proposal_ready_for_human_review_only": True,
    "source_star_law_candidate_rule_violation_response_audit_completion_attestation_completion_boundary_proposal_valid": True,
...
PROPOSED_CANDIDATE_RULE_VIOLATION_RESPONSE_AUDIT_COMPLETION_ATTESTATION_COMPLETION_CLOSURE_BOUNDARY_KEYS = {
    "response_audit_completion_attestation_completion_closure_eligibility_boundary",
    "response_audit_completion_attestation_completion_closure_input_boundary",
    "response_audit_completion_attestation_completion_closure_output_boundary",
    "response_audit_completion_attestation_completion_closure_non_execution_boundary",
    "response_audit_completion_attestation_completion_closure_non_recording_boundary",
    "response_audit_completion_attestation_completion_closure_non_ledger_boundary",
    "response_audit_completion_attestation_completion_closure_non_authorization_boundary",
    ...
    "human_operator_completion_closure_review_boundary",
    "evidence_lineage_completion_closure_boundary",
    "auditability_completion_closure_design_boundary",
    "false_positive_completion_closure_prevention_boundary",
    "rollback_completion_closure_boundary",
    "suspension_completion_closure_boundary",
...
PROPOSAL_COMPONENTS = {
    "source_candidate_rule_violation_response_audit_completion_attestation_completion_boundary_review_gate",
    *PROPOSED_CANDIDATE_RULE_VIOLATION_RESPONSE_AUDIT_COMPLETION_ATTESTATION_COMPLETION_CLOSURE_BOUNDARY_KEYS,
}


def build_governed_star_law_candidate_rule_violation_response_audit_completion_attestation_completion_closure_boundary_proposal(
    review_gate_report: Mapping[str, Any],
) -> dict[str, Any]:
    """Return a local-only, non-authorizing attestation closure proposal."""
    ...
    status = (
        "star_law_candidate_rule_violation_response_audit_completion_attestation_completion_closure_boundary_proposal_ready"
        if ready
        else "blocked"
    )

    return {
        "version": GOVERNED_STAR_LAW_CANDIDATE_RULE_VIOLATION_RESPONSE_AUDIT_COMPLETION_ATTESTATION_COMPLETION_CLOSURE_BOUNDARY_PROPOSAL_VERSION,
        "status": status,
        **PROPOSAL_FLAGS,
        "candidate_rule_violation_response_audit_completion_attestation_completion_closure_boundary_proposed_for_human_review_only": ready,
        "candidate_rule_violation_response_audit_completion_attestation_completion_closure_boundary_review_gate_ready_for_human_review_only": ready,
        ...
        "star_law_candidate_rule_violation_response_audit_completion_attestation_completion_closure_boundary_proposal_summary": _proposal_summary(
            ready
        ),
        "proposal_checks": checks,
        "source_review_gate_summary": _source_review_gate_summary(ready),
        "star_law_candidate_rule_violation_response_audit_completion_attestation_completion_closure_boundary_proposal": _closure_boundary_proposal(
            ready
        ),
        "proposed_candidate_rule_violation_response_audit_completion_attestation_completion_closure_boundaries": _proposed_closure_boundaries(
            ready
        ),
        ...
        "future_candidate_rule_violation_response_audit_completion_attestation_completion_closure_review_gate_constraints": _future_review_gate_constraints(),
...
def governed_star_law_candidate_rule_violation_response_audit_completion_attestation_completion_closure_boundary_proposal_to_json(
    report: Mapping[str, Any],
) -> str:
    """Serialize the attestation closure proposal deterministically."""
...
def _proposal_checks(
    ...
    required_values = {
        "source_review_gate_version": (
            ...
            "source_review_gate_version_must_be_2_56_0",
        ),
        "source_review_gate_status_ready": (
            report.get("status")
            == "star_law_candidate_rule_violation_response_audit_completion_attestation_completion_boundary_review_gate_ready",
            "source_review_gate_status_must_be_star_law_candidate_rule_violation_response_audit_completion_attestation_completion_boundary_review_gate_ready",
        ),
        "source_reviewed_chain_versions": (
            report.get("reviewed_chain_versions")
            == SOURCE_REVIEWED_CHAIN_VERSIONS,
            "source_reviewed_chain_versions_must_exactly_match_v2_9_0_through_v2_55_0",
        ),
        "source_reviewed_star_hub_chain_versions": (
            report.get("reviewed_star_hub_chain_versions")
            == SOURCE_REVIEWED_STAR_HUB_CHAIN_VERSIONS,
            "source_reviewed_star_hub_chain_versions_must_exactly_match_v2_19_0_through_v2_55_0",
        ),
        "source_next_allowed_step": (
            report.get("next_allowed_step")
            == "v2.57.0 Star-Law candidate rule violation response audit completion attestation completion closure boundary proposal",
            "source_next_allowed_step_must_be_v2_57_0_attestation_completion_closure_boundary_proposal",
        ),
        ...
        "source_no_unsafe_true_claims": (
            ...
            "source_must_not_claim_closure_attestation_completion_finalization_audit_response_correction_violation_rule_autonomous_handoff_scheduling_approval_write_execution_dry_run_or_civilization_core_actions",
        ),
        "source_no_unsafe_text_claims": (
            _unsafe_text_claims(report) == [],
            "source_must_not_textually_claim_closure_attestation_completion_finalization_audit_response_correction_violation_rule_autonomous_write_approval_next_layer_or_civilization_core_actions",
        ),
    }
    ...
    if isinstance(mapping, Mapping):
        ...
        layer_checks = {
            ...
            "source_primary_layer_status": (
                ...
                == "Star-Law candidate rule violation response audit completion attestation completion boundary review gate only, not completion execution, not completion record creation, not completion-ledger creation, not finalization execution, not finalization record creation, not finalization-ledger creation, not closure execution, not closure record creation, not closure-ledger creation, not attestation execution, not attestation record creation, not attestation-ledger creation, not audit execution, not audit logging, not audit record creation, not audit-ledger creation, not violation response execution, not automated correction, not violation enforcement, and not autonomous execution",
                "source_primary_layer_status_must_be_attestation_completion_boundary_review_gate_only",
            ),
            "source_source_layer": (
            ...
            "source_source_layer_status": (
                ...
                == "Star-Law candidate rule violation response audit completion attestation completion boundary proposal complete for human review only",
                "source_source_layer_status_must_be_attestation_completion_boundary_proposal_complete_for_human_review_only",
            ),
            ...
            "source_direction": (
                ...
                == "Star-Law candidate rule violation response audit completion attestation completion boundary proposal -> Star-Law candidate rule violation response audit completion attestation completion boundary review gate",
                "source_direction_must_match_attestation_completion_boundary_proposal_to_review_gate",
            ),
        }
    ...
    review_gate = report.get(
        "star_law_candidate_rule_violation_response_audit_completion_attestation_completion_boundary_review_gate"
    )
    _add_check(
        checks,
        blocking_reasons,
        "source_attestation_completion_boundary_review_gate_shape",
        isinstance(review_gate, Mapping),
        "source_attestation_completion_boundary_review_gate_must_be_mapping",
    )
    if isinstance(review_gate, Mapping):
        _add_check(
            checks,
            blocking_reasons,
            "source_attestation_completion_boundary_review_gate_status",
            review_gate.get("review_status")
            == "star_law_candidate_rule_violation_response_audit_completion_attestation_completion_boundary_reviewed_for_human_review_only",
            "source_attestation_completion_boundary_review_gate_status_must_be_human_review_only",
        )
        _add_check(
            checks,
            blocking_reasons,
            "source_attestation_completion_boundary_review_gate_type",
            review_gate.get("boundary_type")
            == "star_law_candidate_rule_violation_response_audit_completion_attestation_completion_boundary_review_gate",
            "source_attestation_completion_boundary_review_gate_type_must_match",
        )
        for key, expected in SOURCE_REVIEW_GATE_REQUIRED_FLAGS.items():
            _add_check(
                checks,
                blocking_reasons,
                f"source_attestation_completion_boundary_review_gate_{key}",
                review_gate.get(key) is expected,
                f"source_attestation_completion_boundary_review_gate_{key}_must_be_{str(expected).lower()}",
            )
        _add_check(
            checks,
            blocking_reasons,
            "source_attestation_completion_boundary_review_gate_chain_versions",
            review_gate.get("reviewed_chain_versions")
            == SOURCE_REVIEWED_CHAIN_VERSIONS,
            "source_attestation_completion_boundary_review_gate_chain_versions_must_match",
        )
        _add_check(
            checks,
            blocking_reasons,
            "source_attestation_completion_boundary_review_gate_star_hub_chain_versions",
            review_gate.get("reviewed_star_hub_chain_versions")
            == SOURCE_REVIEWED_STAR_HUB_CHAIN_VERSIONS,
            "source_attestation_completion_boundary_review_gate_star_hub_chain_versions_must_match",
        )
        _add_check(
            checks,
            blocking_reasons,
            "source_attestation_completion_boundary_review_gate_next_allowed_step",
            review_gate.get("next_allowed_step")
            == "v2.57.0 Star-Law candidate rule violation response audit completion attestation completion closure boundary proposal",
            "source_attestation_completion_boundary_review_gate_next_allowed_step_must_match",
        )

    boundaries = report.get(
        "reviewed_candidate_rule_violation_response_audit_completion_attestation_completion_boundaries"
    )
    _add_check(
        checks,
        blocking_reasons,
        "source_reviewed_attestation_completion_boundaries_shape",
        isinstance(boundaries, Mapping),
        "source_reviewed_attestation_completion_boundaries_must_be_mapping",
    )
    if isinstance(boundaries, Mapping):
        _add_check(
            checks,
            blocking_reasons,
            "source_reviewed_attestation_completion_boundaries_required_keys",
            set(boundaries)
            == SOURCE_PROPOSED_CANDIDATE_RULE_VIOLATION_RESPONSE_AUDIT_COMPLETION_ATTESTATION_COMPLETION_BOUNDARY_KEYS,
            "source_reviewed_attestation_completion_boundaries_must_exactly_match_required_boundaries",
        )
        _add_check(
            checks,
            blocking_reasons,
            "source_reviewed_attestation_completion_boundaries_review_only",
            _reviewed_boundaries_remain_review_only(boundaries),
            "source_reviewed_attestation_completion_boundaries_must_remain_review_only_and_non_authorizing",
        )
        _add_check(
            checks,
            blocking_reasons,
            "source_reviewed_attestation_completion_boundaries_no_unsafe_claims",
            _unsafe_boundary_claims(boundaries, {"review_only"}) == [],
            "source_reviewed_attestation_completion_boundaries_must_not_claim_execution_authorization_recording_enforcement_or_write_actions",
        )
...
def _proposal_summary(ready: bool) -> dict[str, Any]:
    return {
        "proposal_status": (
            "star_law_candidate_rule_violation_response_audit_completion_attestation_completion_closure_boundary_proposed_for_human_review_only"
            if ready
            else "blocked"
        ),
        "source_review_gate_version": SOURCE_REVIEW_GATE_VERSION,
        "source_attestation_completion_boundary_review_gate_valid": ready,
        "candidate_rule_violation_response_audit_completion_attestation_completion_closure_boundary_proposed_for_human_review_only": ready,
        "candidate_rule_violation_response_audit_completion_attestation_completion_closure_boundary_review_gate_ready_for_human_review_only": ready,
        "proposal_only": True,
...
def _closure_boundary_proposal(ready: bool) -> dict[str, Any]:
    return {
        "proposal_status": (
            "star_law_candidate_rule_violation_response_audit_completion_attestation_completion_closure_boundary_proposed_for_human_review_only"
            if ready
            else "blocked_no_attestation_completion_closure_boundary_readiness_claim"
        ),
        "boundary_type": "star_law_candidate_rule_violation_response_audit_completion_attestation_completion_closure_boundary_proposal",
        "source_review_gate_version": SOURCE_REVIEW_GATE_VERSION,
        "candidate_rule_violation_response_audit_completion_attestation_completion_closure_boundary_proposed": ready,
        "candidate_rule_violation_response_audit_completion_attestation_completion_closure_boundary_review_gate_ready_for_human_review_only": ready,
        "source_star_law_candidate_rule_violation_response_audit_completion_attestation_completion_boundary_review_gate_valid": ready,
        **PROPOSAL_OBJECT_FALSE_FLAGS,
        "proposed_chain_versions": list(PROPOSED_CHAIN_VERSIONS),
        "proposed_star_hub_chain_versions": list(
            PROPOSED_STAR_HUB_CHAIN_VERSIONS
        ),
        "star_law_candidate_rule_violation_response_audit_completion_attestation_completion_closure_boundary_components": _proposal_components(
            ready
        ),
        "next_allowed_step": READY_NEXT_ALLOWED_STEP,
        "non_authorization_notice": (
            "This proposal describes candidate audit completion attestation completion closure boundaries for Human Operator review only. It performs no closure, attestation, completion, finalization, audit, response, correction, enforcement, record creation, ledger creation, write, approval, handoff, scheduling, dry-run, or autonomous action."
            if ready
            else "The attestation completion closure boundary proposal is blocked and makes no readiness, execution, authorization, recording, ledger, enforcement, write, approval, handoff, scheduling, next-layer, or Civilization Core completion claim."
        ),
    }
...
def _proposed_closure_boundaries(
    ready: bool,
...
def _boundary_summary(key: str) -> str:
    summaries = {
        "response_audit_completion_attestation_completion_closure_eligibility_boundary": "Eligibility is limited to a valid sanitized v2.56.0 review gate and exact chain traceability.",
        "response_audit_completion_attestation_completion_closure_input_boundary": "Inputs are limited to structural review status, chain metadata, layer mapping, and review-only boundary shape.",
        "response_audit_completion_attestation_completion_closure_output_boundary": "Outputs are limited to sanitized proposal categories for a later governed review gate.",
        "human_operator_completion_closure_review_boundary": "Human Operator review is required before any later governed completion closure stage.",
        "evidence_lineage_completion_closure_boundary": "Evidence lineage is limited to source version and exact chain metadata.",
        "auditability_completion_closure_design_boundary": "Auditability is limited to deterministic local report structure.",
        "false_positive_completion_closure_prevention_boundary": "False-positive completion closure prevention remains a required later Human Operator review concern.",
        "rollback_completion_closure_boundary": "Rollback is a proposal category without rollback action.",
        "suspension_completion_closure_boundary": "Suspension is a proposal category without suspension action.",
...
def _non_authorization_boundary(ready: bool) -> dict[str, Any]:
    return {
        ...
        "only_permits_later_attestation_completion_closure_boundary_review_gate": ready,
...
def _preserved_governance_boundaries() -> list[str]:
    return [
        ...
        "This proposal does not perform or authorize attestation, completion, or finalization execution.",
        "This proposal does not create attestation, completion, or finalization records or ledger entries.",
...
def _future_review_gate_constraints() -> list[str]:
    return [
        "A later v2.58.0 attestation completion closure boundary review gate may consume this sanitized proposal through a separate governed process.",
        "A later review gate remains review-only and cannot execute closure, attestation, completion, finalization, audit, response, correction, enforcement, writes, approvals, handoffs, scheduling, or autonomous actions.",
...
def _next_stage_constraints() -> list[str]:
    return [
        ...
        "v2.57.0 is an audit completion attestation completion closure boundary proposal only.",
...
def _scope_boundaries() -> list[str]:
    return [
        ...
        "This v2.57.0 step is limited to 星律记忆 audit completion attestation completion closure boundary proposal only.",
    ]


def _risk_notes(sensitive_field_count: int) -> list[str]:
    notes = [
        "Proposal readiness must not be interpreted as closure, attestation, completion, finalization, audit, response, correction, enforcement, write, approval, handoff, scheduling, or autonomous authority.",
...
def _required_human_actions(
    ...
    if ready:
        return [
            "human_operator_must_review_v2_57_0_attestation_completion_closure_boundary_proposal_before_any_v2_58_0_review_gate",
    ...
    actions = [
        "repair_source_v2_56_0_attestation_completion_boundary_review_gate_before_attestation_completion_closure_boundary_proposal_can_continue",
        "confirm_all_unsafe_closure_attestation_completion_finalization_audit_response_correction_violation_enforcement_rule_execution_authorization_recording_ledger_write_approval_handoff_and_scheduling_flags_remain_false",
        "rerun_local_v2_57_0_attestation_completion_closure_boundary_proposal_after_blockers_are_resolved",
    ]
    if blocking_reasons:
        actions.append(
            "resolve_blocking_reasons_before_attestation_completion_closure_boundary_proposal_can_be_ready"
        )
    return actions
...
__all__ = [
    ...
    "PROPOSAL_COMPONENTS",
    "SENSITIVE_KEYS",
    "build_governed_star_law_candidate_rule_violation_response_audit_completion_attestation_completion_closure_boundary_proposal",
    "governed_star_law_candidate_rule_violation_response_audit_completion_attestation_completion_closure_boundary_proposal_to_json",
]
