...
GOVERNANCE_SOURCE_CONSTITUTION_REGISTRY_VERSION = "6.8.0"
GOVERNANCE_SOURCE_CONSTITUTION_REGISTRY_SCHEMA_VERSION = "6.8.0"
...
def build_governance_source_constitution_registry() -> dict[str, Any]:
    ...
    blocking_reasons = _deduplicate(
        [
            ...
            *(["Star-Source entry boundary version must be 6.8.0"] if not upstream_version_ready else []),
