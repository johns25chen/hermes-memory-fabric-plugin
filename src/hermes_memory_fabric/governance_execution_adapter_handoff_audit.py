...
GOVERNANCE_EXECUTION_ADAPTER_HANDOFF_AUDIT_VERSION = "5.11.0"
GOVERNANCE_EXECUTION_ADAPTER_HANDOFF_AUDIT_SCHEMA_VERSION = "5.11.0"
...
def build_governance_execution_adapter_handoff_audit() -> dict[str, Any]:
    ...
    blocking_reasons = _deduplicate(
        [
            *(
                ["manifest authorization gate must pass at version 5.11.0"]
