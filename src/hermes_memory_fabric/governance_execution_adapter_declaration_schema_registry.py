...
GOVERNANCE_EXECUTION_ADAPTER_DECLARATION_SCHEMA_REGISTRY_VERSION = "6.7.0"
GOVERNANCE_EXECUTION_ADAPTER_DECLARATION_SCHEMA_REGISTRY_SCHEMA_VERSION = "6.7.0"
...
def build_governance_execution_adapter_declaration_schema_registry() -> dict[str, Any]:
    ...
    blocking_reasons = _deduplicate(
        [
            *(
                ["execution adapter boundary must pass at version 6.7.0"]
        ...
        _check(
            ...
            blocking_reasons=_deduplicate(
                [
                    ...
                    *(
                        ["execution adapter boundary version must equal 6.7.0"]
