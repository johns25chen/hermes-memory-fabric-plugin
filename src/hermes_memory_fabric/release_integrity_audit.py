"""Deterministic local release integrity audit for v2.0.0 through v5.1.0."""
...
RELEASE_INTEGRITY_AUDIT_VERSION = "5.1.0"
...
def run_release_integrity_audit(repo_root: str | Path = ".") -> dict[str, Any]:
    """Run a local, no-network integrity audit for the v2.0-v5.1 release chain."""
