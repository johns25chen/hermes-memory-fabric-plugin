"""Deterministic local release integrity audit for v2.0.0 through v2.53.0."""
...
RELEASE_INTEGRITY_AUDIT_VERSION = "2.53.0"
...
def run_release_integrity_audit(repo_root: str | Path = ".") -> dict[str, Any]:
    """Run a local, no-network integrity audit for the v2.0-v2.53 release chain."""
