...
GOVERNANCE_EXECUTION_ADAPTER_MANIFEST_FIXTURE_PACK_VERSION = "6.5.0"
GOVERNANCE_EXECUTION_ADAPTER_MANIFEST_FIXTURE_PACK_SCHEMA_VERSION = "6.5.0"
...
def build_governance_execution_adapter_manifest_fixture_pack() -> dict[str, Any]:
    ...
    blocking_reasons = _deduplicate(
        [
            *(
                ["manifest dry-run design must pass at version 6.5.0"]
...
def _design_blocking_reasons(design: Mapping[str, Any]) -> list[str]:
    ...
    return _deduplicate(
        [
            ...
            *(
                ["manifest dry-run design version must equal 6.5.0"]
