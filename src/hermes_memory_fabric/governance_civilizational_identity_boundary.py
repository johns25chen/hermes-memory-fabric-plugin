...
GOVERNANCE_CIVILIZATIONAL_IDENTITY_BOUNDARY_VERSION = "6.6.0"
GOVERNANCE_CIVILIZATIONAL_IDENTITY_BOUNDARY_SCHEMA_VERSION = "6.6.0"
...
def build_governance_civilizational_identity_boundary() -> dict[str, Any]:
    ...
    blocking_reasons = _deduplicate(
        [
            *(
                ["Origin Provenance Ledger version must be 6.6.0"]
