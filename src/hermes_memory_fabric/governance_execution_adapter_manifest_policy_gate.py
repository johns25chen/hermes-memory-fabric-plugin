...
GOVERNANCE_EXECUTION_ADAPTER_MANIFEST_POLICY_GATE_VERSION = "5.10.0"
GOVERNANCE_EXECUTION_ADAPTER_MANIFEST_POLICY_GATE_SCHEMA_VERSION = "5.10.0"
...
def build_governance_execution_adapter_manifest_policy_gate() -> dict[str, Any]:
    ...
    blocking_reasons = _deduplicate(
        [
            *(
                ["manifest validation matrix must pass at version 5.10.0"]
...
def _manifest_validation_matrix_blocking_reasons(
    ...
    return _deduplicate(
        [
            ...
            *(
                ["manifest validation matrix version must equal 5.10.0"]
