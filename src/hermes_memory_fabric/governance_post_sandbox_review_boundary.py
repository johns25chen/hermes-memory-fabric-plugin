...
GOVERNANCE_POST_SANDBOX_REVIEW_BOUNDARY_VERSION = "6.2.0"
GOVERNANCE_POST_SANDBOX_REVIEW_BOUNDARY_SCHEMA_VERSION = "6.2.0"
...
def build_governance_post_sandbox_review_boundary() -> dict[str, Any]:
    ...
    blocking_reasons = _deduplicate(
        [
            *(
                ["controlled adapter sandbox candidate must pass at version 6.2.0"]
