...
GOVERNANCE_EXECUTION_ADAPTER_BOUNDARY_VERSION = "5.13.0"
GOVERNANCE_EXECUTION_ADAPTER_BOUNDARY_SCHEMA_VERSION = "5.13.0"
        ...
        _boundary_check(
            ...
            blocking_reasons=_deduplicate(
                [
                    ...
                    *(
                        ["readiness audit version must equal 5.13.0"]
