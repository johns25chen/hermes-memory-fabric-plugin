...
GOVERNANCE_CROSS_SYSTEM_COORDINATION_BOUNDARY_VERSION = "6.5.0"
GOVERNANCE_CROSS_SYSTEM_COORDINATION_BOUNDARY_SCHEMA_VERSION = "6.5.0"
...
def build_governance_cross_system_coordination_boundary() -> dict[str, Any]:
    ...
    blocking_reasons = _deduplicate(
        [
            *(
                ["operation ledger proposal boundary must pass at version 6.5.0"]
