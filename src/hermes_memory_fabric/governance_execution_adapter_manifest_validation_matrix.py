...
GOVERNANCE_EXECUTION_ADAPTER_MANIFEST_VALIDATION_MATRIX_VERSION = "5.6.0"
GOVERNANCE_EXECUTION_ADAPTER_MANIFEST_VALIDATION_MATRIX_SCHEMA_VERSION = "5.6.0"
...
def build_governance_execution_adapter_manifest_validation_matrix() -> dict[str, Any]:
    ...
    blocking_reasons = _deduplicate(
        [
            *(
                ["manifest fixture pack must pass at version 5.6.0"]
...
def _fixture_pack_blocking_reasons(
    ...
    return _deduplicate(
        [
            ...
            *(
                ["manifest fixture pack version must equal 5.6.0"]
