"""Governed Star-Law audit completion attestation closure boundary proposal."""
...
from .governed_star_law_candidate_rule_violation_response_audit_completion_attestation_boundary_review_gate import (
    ...
    SENSITIVE_KEYS,
    SOURCE_PROPOSED_CANDIDATE_RULE_VIOLATION_RESPONSE_AUDIT_COMPLETION_ATTESTATION_BOUNDARY_KEYS,
)


GOVERNED_STAR_LAW_CANDIDATE_RULE_VIOLATION_RESPONSE_AUDIT_COMPLETION_ATTESTATION_CLOSURE_BOUNDARY_PROPOSAL_VERSION = (
    "2.51.0"
)
SOURCE_REVIEW_GATE_VERSION = "2.50.0"

PROPOSED_CHAIN_VERSIONS = [*SOURCE_REVIEWED_CHAIN_VERSIONS, "v2.50.0"]
...
LAYER_MAPPING = {
    "primary_layer": "星律记忆",
    "primary_layer_status": "Star-Law candidate rule violation response audit completion attestation closure boundary proposal only, not closure execution, not closure record creation, not closure-ledger creation, not attestation execution, not attestation record creation, not attestation-ledger creation, not completion execution, not finalization execution, not audit execution, not audit logging, not audit record creation, not audit-ledger creation, not violation response execution, not automated correction, not violation enforcement, and not autonomous execution",
    "source_layer": "星律记忆",
    "source_layer_status": "Star-Law candidate rule violation response audit completion attestation boundary review gate complete for human review only",
    "supporting_layers": ["星穹记忆", "星域记忆", "星界记忆", "星辰记忆"],
    "direction": "Star-Law candidate rule violation response audit completion attestation boundary review gate -> Star-Law candidate rule violation response audit completion attestation closure boundary proposal",
}

READY_NEXT_ALLOWED_STEP = (
    "v2.52.0 Star-Law candidate rule violation response audit completion attestation closure boundary review gate"
)

ATTESTATION_CLOSURE_FALSE_FLAGS = {
    "candidate_rule_violation_response_audit_completion_attestation_closure_performed": False,
    "candidate_rule_violation_response_audit_completion_attestation_closure_authorized": False,
    "candidate_rule_violation_response_audit_completion_attestation_closure_executed": False,
    "candidate_rule_violation_response_audit_completion_attestation_closure_execution_authorized": False,
    "candidate_rule_violation_response_audit_completion_attestation_closure_record_created": False,
    "candidate_rule_violation_response_audit_completion_attestation_closure_ledger_entry_created": False,
}
...
PROPOSAL_FLAGS = {
    ...
    "proposal_only": True,
    "candidate_rule_violation_response_audit_completion_attestation_closure_boundary_proposal_only": True,
    "star_law_candidate_rule_violation_response_audit_completion_attestation_closure_boundary_proposal_only": True,
    **PROPOSAL_FALSE_FLAGS,
}
...
SOURCE_REQUIRED_FLAGS = {
    ...
    "candidate_rule_violation_response_audit_completion_attestation_boundary_review_gate_only": True,
    "star_law_candidate_rule_violation_response_audit_completion_attestation_boundary_review_gate_only": True,
    "candidate_rule_violation_response_audit_completion_attestation_boundary_reviewed_for_human_review_only": True,
    "candidate_rule_violation_response_audit_completion_attestation_closure_boundary_proposal_ready_for_human_review_only": True,
    **SOURCE_REVIEW_GATE_FALSE_FLAGS,
}

SOURCE_REVIEW_GATE_REQUIRED_FLAGS = {
    "candidate_rule_violation_response_audit_completion_attestation_boundary_reviewed": True,
    "candidate_rule_violation_response_audit_completion_attestation_boundary_structurally_review_ready": True,
    "candidate_rule_violation_response_audit_completion_attestation_closure_boundary_proposal_ready_for_human_review_only": True,
    "source_star_law_candidate_rule_violation_response_audit_completion_attestation_boundary_proposal_valid": True,
...
PROPOSED_CANDIDATE_RULE_VIOLATION_RESPONSE_AUDIT_COMPLETION_ATTESTATION_CLOSURE_BOUNDARY_KEYS = {
    "response_audit_completion_attestation_closure_eligibility_boundary",
    "response_audit_completion_attestation_closure_input_boundary",
    "response_audit_completion_attestation_closure_output_boundary",
    "response_audit_completion_attestation_closure_non_execution_boundary",
    "response_audit_completion_attestation_closure_non_recording_boundary",
    "response_audit_completion_attestation_closure_non_ledger_boundary",
    "response_audit_completion_attestation_closure_non_authorization_boundary",
...
PROPOSAL_COMPONENTS = {
    "source_candidate_rule_violation_response_audit_completion_attestation_boundary_review_gate",
    *PROPOSED_CANDIDATE_RULE_VIOLATION_RESPONSE_AUDIT_COMPLETION_ATTESTATION_CLOSURE_BOUNDARY_KEYS,
}


def build_governed_star_law_candidate_rule_violation_response_audit_completion_attestation_closure_boundary_proposal(
    ...
    return {
        "version": GOVERNED_STAR_LAW_CANDIDATE_RULE_VIOLATION_RESPONSE_AUDIT_COMPLETION_ATTESTATION_CLOSURE_BOUNDARY_PROPOSAL_VERSION,
        "status": status,
        **PROPOSAL_FLAGS,
        "candidate_rule_violation_response_audit_completion_attestation_closure_boundary_proposed_for_human_review_only": ready,
        "candidate_rule_violation_response_audit_completion_attestation_closure_boundary_review_gate_ready_for_human_review_only": ready,
        ...
        "star_law_candidate_rule_violation_response_audit_completion_attestation_closure_boundary_proposal_summary": _proposal_summary(
            ready
        ),
        "proposal_checks": checks,
        "source_review_gate_summary": _source_review_gate_summary(ready),
        "star_law_candidate_rule_violation_response_audit_completion_attestation_closure_boundary_proposal": _closure_boundary_proposal(
            ready
        ),
        "proposed_candidate_rule_violation_response_audit_completion_attestation_closure_boundaries": _proposed_closure_boundaries(
            ready
        ),
        ...
        "future_candidate_rule_violation_response_audit_completion_attestation_closure_review_gate_constraints": _future_review_gate_constraints(),
...
def governed_star_law_candidate_rule_violation_response_audit_completion_attestation_closure_boundary_proposal_to_json(
...
def _proposal_checks(
    ...
    required_values = {
        "source_review_gate_version": (
            ...
            "source_review_gate_version_must_be_2_50_0",
        ),
        "source_review_gate_status_ready": (
            report.get("status")
            == "star_law_candidate_rule_violation_response_audit_completion_attestation_boundary_review_gate_ready",
            "source_review_gate_status_must_be_star_law_candidate_rule_violation_response_audit_completion_attestation_boundary_review_gate_ready",
        ),
        "source_reviewed_chain_versions": (
            report.get("reviewed_chain_versions")
            == SOURCE_REVIEWED_CHAIN_VERSIONS,
            "source_reviewed_chain_versions_must_exactly_match_v2_9_0_through_v2_49_0",
        ),
        "source_reviewed_star_hub_chain_versions": (
            report.get("reviewed_star_hub_chain_versions")
            == SOURCE_REVIEWED_STAR_HUB_CHAIN_VERSIONS,
            "source_reviewed_star_hub_chain_versions_must_exactly_match_v2_19_0_through_v2_49_0",
        ),
        "source_next_allowed_step": (
            report.get("next_allowed_step")
            == "v2.51.0 Star-Law candidate rule violation response audit completion attestation closure boundary proposal",
            "source_next_allowed_step_must_be_v2_51_0_attestation_closure_boundary_proposal",
        ),
    ...
    if isinstance(mapping, Mapping):
        ...
        layer_checks = {
            ...
            "source_primary_layer_status": (
                ...
                == "Star-Law candidate rule violation response audit completion attestation boundary review gate only, not attestation execution, not attestation record creation, not attestation-ledger creation, not completion execution, not finalization execution, not closure execution, not audit execution, not audit logging, not audit record creation, not audit-ledger creation, not violation response execution, not automated correction, not violation enforcement, and not autonomous execution",
                "source_primary_layer_status_must_be_attestation_boundary_review_gate_only",
            ),
            "source_source_layer": (
            ...
            "source_source_layer_status": (
                ...
                == "Star-Law candidate rule violation response audit completion attestation boundary proposal complete for human review only",
                "source_source_layer_status_must_be_attestation_boundary_proposal_complete_for_human_review_only",
            ),
            ...
            "source_direction": (
                ...
                == "Star-Law candidate rule violation response audit completion attestation boundary proposal -> Star-Law candidate rule violation response audit completion attestation boundary review gate",
                "source_direction_must_match_attestation_boundary_proposal_to_review_gate",
            ),
        }
    ...
    review_gate = report.get(
        "star_law_candidate_rule_violation_response_audit_completion_attestation_boundary_review_gate"
    )
    _add_check(
        checks,
        blocking_reasons,
        "source_attestation_boundary_review_gate_shape",
        isinstance(review_gate, Mapping),
        "source_attestation_boundary_review_gate_must_be_mapping",
    )
    if isinstance(review_gate, Mapping):
        _add_check(
            checks,
            blocking_reasons,
            "source_attestation_boundary_review_gate_status",
            review_gate.get("review_status")
            == "star_law_candidate_rule_violation_response_audit_completion_attestation_boundary_reviewed_for_human_review_only",
            "source_attestation_boundary_review_gate_status_must_be_human_review_only",
        )
        _add_check(
            checks,
            blocking_reasons,
            "source_attestation_boundary_review_gate_type",
            review_gate.get("boundary_type")
            == "star_law_candidate_rule_violation_response_audit_completion_attestation_boundary_review_gate",
            "source_attestation_boundary_review_gate_type_must_match",
        )
        for key, expected in SOURCE_REVIEW_GATE_REQUIRED_FLAGS.items():
            _add_check(
                checks,
                blocking_reasons,
                f"source_attestation_boundary_review_gate_{key}",
                review_gate.get(key) is expected,
                f"source_attestation_boundary_review_gate_{key}_must_be_{str(expected).lower()}",
            )
        _add_check(
            checks,
            blocking_reasons,
            "source_attestation_boundary_review_gate_chain_versions",
            review_gate.get("reviewed_chain_versions")
            == SOURCE_REVIEWED_CHAIN_VERSIONS,
            "source_attestation_boundary_review_gate_chain_versions_must_match",
        )
        _add_check(
            checks,
            blocking_reasons,
            "source_attestation_boundary_review_gate_star_hub_chain_versions",
            review_gate.get("reviewed_star_hub_chain_versions")
            == SOURCE_REVIEWED_STAR_HUB_CHAIN_VERSIONS,
            "source_attestation_boundary_review_gate_star_hub_chain_versions_must_match",
        )
        _add_check(
            checks,
            blocking_reasons,
            "source_attestation_boundary_review_gate_next_allowed_step",
            review_gate.get("next_allowed_step")
            == "v2.51.0 Star-Law candidate rule violation response audit completion attestation closure boundary proposal",
            "source_attestation_boundary_review_gate_next_allowed_step_must_match",
        )

    boundaries = report.get(
        "reviewed_candidate_rule_violation_response_audit_completion_attestation_boundaries"
    )
    _add_check(
        checks,
        blocking_reasons,
        "source_reviewed_attestation_boundaries_shape",
        isinstance(boundaries, Mapping),
        "source_reviewed_attestation_boundaries_must_be_mapping",
    )
    if isinstance(boundaries, Mapping):
        _add_check(
            checks,
            blocking_reasons,
            "source_reviewed_attestation_boundaries_required_keys",
            set(boundaries)
            == SOURCE_PROPOSED_CANDIDATE_RULE_VIOLATION_RESPONSE_AUDIT_COMPLETION_ATTESTATION_BOUNDARY_KEYS,
            "source_reviewed_attestation_boundaries_must_exactly_match_required_boundaries",
        )
        _add_check(
            checks,
            blocking_reasons,
            "source_reviewed_attestation_boundaries_review_only",
            _reviewed_boundaries_remain_review_only(boundaries),
            "source_reviewed_attestation_boundaries_must_remain_review_only_and_non_authorizing",
        )
        _add_check(
            checks,
            blocking_reasons,
            "source_reviewed_attestation_boundaries_no_unsafe_claims",
            _unsafe_boundary_claims(boundaries, {"review_only"}) == [],
            "source_reviewed_attestation_boundaries_must_not_claim_execution_authorization_recording_enforcement_or_write_actions",
        )
...
def _proposal_summary(ready: bool) -> dict[str, Any]:
    return {
        "proposal_status": (
            "star_law_candidate_rule_violation_response_audit_completion_attestation_closure_boundary_proposed_for_human_review_only"
            if ready
            else "blocked"
        ),
        "source_review_gate_version": SOURCE_REVIEW_GATE_VERSION,
        "source_attestation_boundary_review_gate_valid": ready,
        "candidate_rule_violation_response_audit_completion_attestation_closure_boundary_proposed_for_human_review_only": ready,
        "candidate_rule_violation_response_audit_completion_attestation_closure_boundary_review_gate_ready_for_human_review_only": ready,
        "proposal_only": True,
...
def _closure_boundary_proposal(ready: bool) -> dict[str, Any]:
    return {
        "proposal_status": (
            "star_law_candidate_rule_violation_response_audit_completion_attestation_closure_boundary_proposed_for_human_review_only"
            if ready
            else "blocked_no_attestation_closure_boundary_readiness_claim"
        ),
        "boundary_type": "star_law_candidate_rule_violation_response_audit_completion_attestation_closure_boundary_proposal",
        "source_review_gate_version": SOURCE_REVIEW_GATE_VERSION,
        "candidate_rule_violation_response_audit_completion_attestation_closure_boundary_proposed": ready,
        "candidate_rule_violation_response_audit_completion_attestation_closure_boundary_review_gate_ready_for_human_review_only": ready,
        "source_star_law_candidate_rule_violation_response_audit_completion_attestation_boundary_review_gate_valid": ready,
        **PROPOSAL_OBJECT_FALSE_FLAGS,
        "proposed_chain_versions": list(PROPOSED_CHAIN_VERSIONS),
        "proposed_star_hub_chain_versions": list(
            PROPOSED_STAR_HUB_CHAIN_VERSIONS
        ),
        "star_law_candidate_rule_violation_response_audit_completion_attestation_closure_boundary_components": _proposal_components(
            ready
        ),
        "next_allowed_step": READY_NEXT_ALLOWED_STEP,
        "non_authorization_notice": (
            "This proposal describes candidate audit completion attestation closure boundaries for Human Operator review only. It performs no closure, attestation, completion, finalization, audit, response, correction, enforcement, record creation, ledger creation, write, approval, handoff, scheduling, dry-run, or autonomous action."
            if ready
            else "The attestation closure boundary proposal is blocked and makes no readiness, execution, authorization, recording, ledger, enforcement, write, approval, handoff, scheduling, next-layer, or Civilization Core completion claim."
        ),
    }
...
def _boundary_summary(key: str) -> str:
    summaries = {
        "response_audit_completion_attestation_closure_eligibility_boundary": "Eligibility is limited to a valid sanitized v2.50 review gate and exact chain traceability.",
        "response_audit_completion_attestation_closure_input_boundary": "Inputs are limited to structural review status, chain metadata, layer mapping, and review-only boundary shape.",
        "response_audit_completion_attestation_closure_output_boundary": "Outputs are limited to sanitized proposal categories for a later governed review gate.",
        "human_operator_closure_review_boundary": "Human Operator review is required before any later governed closure stage.",
        "evidence_lineage_closure_boundary": "Evidence lineage is limited to source version and exact chain metadata.",
        "auditability_closure_design_boundary": "Auditability is limited to deterministic local report structure.",
        "false_positive_closure_prevention_boundary": "False-positive closure prevention remains a required later Human Operator review concern.",
        "rollback_closure_boundary": "Rollback is a proposal category without rollback action.",
        "suspension_closure_boundary": "Suspension is a proposal category without suspension action.",
...
def _non_authorization_boundary(ready: bool) -> dict[str, Any]:
    return {
        ...
        "only_permits_later_attestation_closure_boundary_review_gate": ready,
...
def _future_review_gate_constraints() -> list[str]:
    return [
        "A later v2.52.0 attestation closure boundary review gate may consume this sanitized proposal through a separate governed process.",
...
def _next_stage_constraints() -> list[str]:
    return [
        ...
        "v2.51.0 is an audit completion attestation closure boundary proposal only.",
...
def _scope_boundaries() -> list[str]:
    return [
        ...
        "This v2.51.0 step is limited to 星律记忆 audit completion attestation closure boundary proposal only.",
    ]
...
def _required_human_actions(
    ...
    if ready:
        return [
            "human_operator_must_review_v2_51_0_attestation_closure_boundary_proposal_before_any_v2_52_0_review_gate",
    ...
    actions = [
        "repair_source_v2_50_0_attestation_boundary_review_gate_before_attestation_closure_boundary_proposal_can_continue",
        ...
        "rerun_local_v2_51_0_attestation_closure_boundary_proposal_after_blockers_are_resolved",
    ]
    if blocking_reasons:
        actions.append(
            "resolve_blocking_reasons_before_attestation_closure_boundary_proposal_can_be_ready"
        )
    return actions
...
__all__ = [
    ...
    "governed_star_law_candidate_rule_violation_response_audit_completion_attestation_closure_boundary_proposal_to_json",
]
