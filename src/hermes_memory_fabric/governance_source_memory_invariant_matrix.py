...
GOVERNANCE_SOURCE_MEMORY_INVARIANT_MATRIX_VERSION = "6.8.0"
GOVERNANCE_SOURCE_MEMORY_INVARIANT_MATRIX_SCHEMA_VERSION = "6.8.0"
...
def build_governance_source_memory_invariant_matrix() -> dict[str, Any]:
    ...
    blocking_reasons = _deduplicate(
        [
            *(
                ["Civilizational Identity Boundary version must be 6.8.0"]
